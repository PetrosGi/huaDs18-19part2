...
<body items="${student}" var="student"
	...
	<div class="w3-top">
		<div class="w3-bar w3-sand w3-card w3-left-align w3-large">
			...
			<a href="#info"
				...
				φοιτητή</a> <a id="pet1nav" href="#pet1"
				class="w3-bar-item w3-button w3-hide-small w3-padding-large w3-hover-khaki">Αίτηση
				#1</a> <a id="pet2nav" href="#pet2"
				class="w3-bar-item w3-button w3-hide-small w3-padding-large w3-hover-khaki">Αίτηση
				#2</a> <a id="pet3nav" href="#pet3"
				class="w3-bar-item w3-button w3-hide-small w3-padding-large w3-hover-khaki">Αίτηση
				#3</a>
		...
		<div id="navDemo"
			...
			<a href="ds/api/studentTest/${student.sid}"
	...
	<div class="w3-container w3-padding-64">
		<form action="/ds/api/studentP/${student.sid}" method="get">
			<input type="submit" value="Αίτηση Πρακτικής" id="petButton"
